...
>
  ...
  <p className="mt-4 text-slate-600">
    Have a project, partnership opportunity, or business inquiry?
    Contact the Skylee team directly.
  </p>

  <a
    href="mailto:hr@skylee.org?subject=Inquiry from Skylee Website"
    className="mt-8 inline-flex w-full items-center justify-center rounded-xl bg-[#2F80ED] px-6 py-4 font-semibold text-white transition hover:bg-[#0F2747]"
  >
    Email Skylee Team
  </a>

  <a
    href="tel:+17047962050"
    className="mt-4 inline-flex w-full items-center justify-center rounded-xl border border-slate-200 px-6 py-4 font-semibold text-[#0F2747]"
  >
    Call Us
  </a>
</div>
